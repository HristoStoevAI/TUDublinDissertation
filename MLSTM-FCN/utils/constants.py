...
TRAIN_FILES = ['../data/arabic/', # 0
               ...
               '../data/eeg_alco_2/',  # 50
               '../data/eeg_alco_3/',  # 51
               '../data/eeg_seizure_0/',  # 52
               '../data/eeg_seizure_1/',  # 53
               '../data/eeg_seizure_2/',  # 54
               '../data/eeg_seizure_3/',  # 55
               '../data/eeg_schizo_0/',  # 56
               '../data/eeg_schizo_1/',  # 57
               '../data/eeg_schizo_2/',  # 58
               '../data/eeg_schizo_3/',  # 59
               '../data/eeg_alco_large/',  # 60
